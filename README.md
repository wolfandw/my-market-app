# Модуль 2. Спринт 6. Веб-приложение «Витрина интернет-магазина» с использованием Spring Boot на реактивном стеке технологий
...
- Создать и запустить контейнер приложение:
    - Запустить в терминале```sudo docker run --name my-market-app-container -p 8080:8080 my-market-app-image```
